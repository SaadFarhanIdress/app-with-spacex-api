...
export type MissionsListQuery = { __typename?: 'Query', missions?: Maybe<Array<Maybe<{ __typename?: 'Mission', mission_name?: Maybe<string>, mission_id?: Maybe<string> }>>> };

export type MissionProfileQueryVariables = Exact<{
  missionId: Scalars['String'];
}>;


export type MissionProfileQuery = { __typename?: 'Query', mission?: Maybe<{ __typename?: 'Mission', mission_name?: Maybe<string>, manufacturers?: Maybe<Array<Maybe<string>>>, wikipedia?: Maybe<string>, website?: Maybe<string>, twitter?: Maybe<string>, description?: Maybe<string> }> };

export type RocketsListQueryVariables = Exact<{ [key: string]: never; }>;


export type RocketsListQuery = { __typename?: 'Query', rockets?: Maybe<Array<Maybe<{ __typename?: 'Rocket', rocket_name?: Maybe<string>, rocket_id?: Maybe<string> }>>> };

export type RocketProfileQueryVariables = Exact<{
  rocketId: Scalars['String'];
}>;


export type RocketProfileQuery = { __typename?: 'Query', rocket?: Maybe<{ __typename?: 'Rocket', active?: Maybe<boolean>, flickr_images?: Maybe<Array<Maybe<string>>>, wikipedia?: Maybe<string>, description?: Maybe<string>, rocket_name?: Maybe<string> }> };
...
export function useMissionsListQuery(baseOptions?: Apollo.QueryHookOptions<MissionsListQuery, MissionsListQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<MissionsListQuery, MissionsListQueryVariables>(MissionsListDocument, options);
      }
export function useMissionsListLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<MissionsListQuery, MissionsListQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<MissionsListQuery, MissionsListQueryVariables>(MissionsListDocument, options);
        }
...
export const MissionProfileDocument = gql`
...
/**
 * __useMissionProfileQuery__
 *
 * To run a query within a React component, call `useMissionProfileQuery` and pass it any options that fit your needs.
 * When your component renders, `useMissionProfileQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useMissionProfileQuery({
 *   variables: {
 *      missionId: // value for 'missionId'
 *   },
 * });
 */
export function useMissionProfileQuery(baseOptions: Apollo.QueryHookOptions<MissionProfileQuery, MissionProfileQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<MissionProfileQuery, MissionProfileQueryVariables>(MissionProfileDocument, options);
      }
export function useMissionProfileLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<MissionProfileQuery, MissionProfileQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<MissionProfileQuery, MissionProfileQueryVariables>(MissionProfileDocument, options);
        }
export type MissionProfileQueryHookResult = ReturnType<typeof useMissionProfileQuery>;
export type MissionProfileLazyQueryHookResult = ReturnType<typeof useMissionProfileLazyQuery>;
export type MissionProfileQueryResult = Apollo.QueryResult<MissionProfileQuery, MissionProfileQueryVariables>;
...
/**
 * __useRocketsListQuery__
 *
 * To run a query within a React component, call `useRocketsListQuery` and pass it any options that fit your needs.
 * When your component renders, `useRocketsListQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useRocketsListQuery({
 *   variables: {
 *   },
 * });
 */
export function useRocketsListQuery(baseOptions?: Apollo.QueryHookOptions<RocketsListQuery, RocketsListQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<RocketsListQuery, RocketsListQueryVariables>(RocketsListDocument, options);
      }
export function useRocketsListLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<RocketsListQuery, RocketsListQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<RocketsListQuery, RocketsListQueryVariables>(RocketsListDocument, options);
        }
...
export const RocketProfileDocument = gql`
...
/**
 * __useRocketProfileQuery__
 *
 * To run a query within a React component, call `useRocketProfileQuery` and pass it any options that fit your needs.
 * When your component renders, `useRocketProfileQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useRocketProfileQuery({
 *   variables: {
 *      rocketId: // value for 'rocketId'
 *   },
 * });
 */
export function useRocketProfileQuery(baseOptions: Apollo.QueryHookOptions<RocketProfileQuery, RocketProfileQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<RocketProfileQuery, RocketProfileQueryVariables>(RocketProfileDocument, options);
      }
export function useRocketProfileLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<RocketProfileQuery, RocketProfileQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<RocketProfileQuery, RocketProfileQueryVariables>(RocketProfileDocument, options);
        }
export type RocketProfileQueryHookResult = ReturnType<typeof useRocketProfileQuery>;
export type RocketProfileLazyQueryHookResult = ReturnType<typeof useRocketProfileLazyQuery>;
export type RocketProfileQueryResult = Apollo.QueryResult<RocketProfileQuery, RocketProfileQueryVariables>;